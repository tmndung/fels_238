        ...
        <div class="row wrapper">
            <div class="left">
                ...
                <ul class="ul-list-manage">
                    <li class="li-list-manage" ><a href="{{ route('admin.category.index') }}"><i class="icon-cat fa fa-list-ul" aria-hidden="true"></i>@lang('lang.categories')<span class="visited"></span></a></li>
                    ...
                    <li class="li-list-manage"><a href="{{ route('admin.wordlist.index') }}"><i class="icon-cat fa fa-list-alt" aria-hidden="true"></i>@lang('lang.wordlists')<span class="visited"></span></a></li>
                </ul>
            </div>
            <div class="right">

...
@section ('title', trans('lang.review'))
    ...
    <div class="learning-container">
        ...
        <div class="progress-content learning-footer full-width clearfix">
            <div class="action-test btn-text btn-learning-next">
                <a href="" id="review-next-word" lesson="{{ $lesson->id }}" offsetProgress="{{ $offsetProgress }}" course="{{ $course->id }}" role="{{ $roleAjax }}">   @lang('lang.next')
                </a>
            </div>
        </div>
    </div>
